...
public class Day6_PurchaseProducts {
	WebDriver driver;
  ...
  public void PurchaseProducts() throws InterruptedException {
	  ...
	  driver.findElement(By.xpath("//button[@onclick='addAllWItemsToCart()']/span")).click();
	  String AddCartMsg = driver.findElement(By.xpath("//*[@id=\"top\"]/body/div/div/div[2]/div/div/div/ul/li/ul/li/span")).getText();
	  System.out.println("The message is like " +AddCartMsg);
	    ...
	    driver.findElement(By.id("postcode")).sendKeys("2000");
	 	...
	 	driver.findElement(By.xpath("//button[@title='Estimate']/span")).click();
	   ...
	   /* driver.findElement(By.xpath("//button[@title='Proceed to Checkout']")).click();
		 ...
		 new Select (driver.findElement(By.xpath("//select[@title='State/Province']"))).selectByVisibleText("New York");
		 driver.findElement(By.xpath("//input[@title='Zip']")).sendKeys("542896");
		 ...
		 new Select(driver.findElement(By.xpath("//select[@id='country']"))).selectByIndex(14);
		 	...
		 	String verifypagetitle = driver.findElement(By.xpath("//div[@class='page-title']/h1")).getText();
		 	System.out.println("The page heading is :" +verifypagetitle);*/
	 ...
	 // 11. Click PROCEED TO CHECKOUT                                                                       
	    ...
	    driver.findElement(By.id("billing:telephone")).sendKeys("8850 6789");  // check radio button to "Ship to different address" 
